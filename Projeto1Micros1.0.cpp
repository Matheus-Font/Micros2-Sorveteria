// Projeto1Micros1.0.cpp : Define o ponto de entrada para o aplicativo.
//

#include "framework.h"
#include "Projeto1Micros1.0.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PROJETO1MICROS10, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PROJETO1MICROS10));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDD_JANELA));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_PROJETO1MICROS10);
    ...
    case WM_COMMAND:
        {
            ...
            {
            case IDM_ABOUT:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_JANELA), hWnd, About);
                break;
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
